...
public class Cas {
	...
	public void setListTest(List<TestPcr> listTest) {
		this.listTest = listTest;
	}

	// Constructeurs
	public Cas(int id, String nom) throws WrongNameFormatException {
		this.id = id;
		this.setNom(nom);
	...
	public void setEtat(int etat) {
		if (validateEtat(etat)) this.etat = etat;
	}
	...
	public void setAdresse(String adresse) {
		if (validateAdresse(adresse)) this.adresse = adresse;
	}
	...
	public void setCodePostale(String codePostale) {
		if (validateCodePostal(codePostale)) this.codePostale = codePostale;
	}
	...
	public void setTel(String tel) {
		if (validateTel(tel)) this.tel = tel;
	}
